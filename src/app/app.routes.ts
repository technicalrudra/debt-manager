...
export const routes: Routes = [
  ...
  { path: 'pending-approval', loadComponent: () => import('./features/auth/pending-approval/pending-approval').then(m => m.PendingApproval) },
  {
    ...
    children: [
      ...
      { path: 'debts/:id', data: { module: 'debts' }, canActivate: [() => import('./core/guards/module.guard').then(m => m.moduleGuard)], loadComponent: () => import('./features/debts/debt-detail/debt-detail').then(m => m.DebtDetail) },
